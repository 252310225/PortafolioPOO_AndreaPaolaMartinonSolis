...
+ Actividad de Evaluación C2 - Consumo Energetico de Servidores U3/Métodos.
+ Actividad de Evaluación C3 - Usuarios.
+ Actividad Integradora C4 - Arreglos Unidimensionales.
+ Actividad Integradora C4 - Gestión de Bitácoras en Archivos de Texto.
